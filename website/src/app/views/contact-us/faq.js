    ...
    },
    {
      ...
      answer: (
        <>
          ...
          <p className="faq-p">
            This year, we are also planning to host an educational bootcamp for
            both developers and designers so that new members can learn relevant
            skills for their role before starting work on their projects!
          </p>
        </>
      ),
    },
