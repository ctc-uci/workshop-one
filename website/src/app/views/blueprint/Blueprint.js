  ...
  return (
    <div className="blueprint-project-card">
      ...
      <div className="blueprint-project-container">
        <iframe
          src={url}
          className="blueprint-project-iframe"
          allow="autoplay"
          title={name}
          allowFullScreen
        />
...
function Blueprint() {
  ...
  return (
    <div className="blueprint-page">
      ...
      <div className="blueprint-projects">{projectCards}</div>
      <iframe
        src="https://docs.google.com/forms/d/e/1FAIpQLScXUic4Ybo18ekf5zEgpUMBp84i0IS6oji7A4QgBWN8vVaf7g/viewform?embedded=true"
        width="90%"
        height="1000"
        frameBorder="0"
        marginHeight="0"
